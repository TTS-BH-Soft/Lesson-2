...
export const InfoBox = tw.div`
  w-[664px] lg:w-full lg:flex lg:flex-col lg:items-center lg:text-center
`
...
export const Title = tw.h5`
  mb-2 text-lg font-semibold lg:text-base
`

export const Subtitle = tw.h2`
  mb-4 font-semibold text-2xl lg:text-xl
`
...
export const Paragraph = tw.p`
  mb-6 leading-6 tracking-wide lg:mb-4
`
...
export const Link = tw.a`
  flex items-center ml-10 text-gray-500 no-underline lg:ml-0
`

export const LinkText = tw.span`
  ml-2 text-sm tracking-wide lg:text-xs lg:ml-0
`
