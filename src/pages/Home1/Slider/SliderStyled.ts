...
export const SliderContainer = tw.div`
  relative top-[204px] left-[189px] h-[542px] max-w-[1098px]
...
export const Title = tw.h1`
  w-[430px] h-[128px] [font-weight: 600] [letter-spacing: 1px]
  // lg:text-xl lg:leading-[1.2] lg:mx-auto lg:h-[60px]
  // sm:text-[1.2rem]
`

export const Paragraph = tw.p`
  text-[#091156] w-[474px] h-[54px] m-0 [font-weight: 600] leading-[24px] [letter-spacing: 1.7px]
